...
import {
  ...
  IconSpeaker, IconSpeakerOff, IconLogout,
} from './icons'
  ...
  return (
    <ToastProvider>
      <div className="flex h-screen flex-col">
        ...
        {/* Topbar */}
        <header className="flex shrink-0 items-center gap-4 border-b px-5 py-3" style={{ borderColor: 'var(--border)', background: 'var(--surface)' }}>
